...
class MiniPayGoodDappGoodDollarVerificationSteps
    extends ConsumerStatefulWidget {
  const MiniPayGoodDappGoodDollarVerificationSteps({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _MinipayGoodDappGoodDollarVerificationStepsState();
}

class _MinipayGoodDappGoodDollarVerificationStepsState
    extends ConsumerState<MiniPayGoodDappGoodDollarVerificationSteps> {
