import { 
  ...
  if (!PRIVY_WALLET_AUTH_PRIVATE_KEY) throw new Error("Missing PRIVY_WALLET_AUTH_PRIVATE_KEY");
  ...
  export const create2Factory: Address = "0x4e59b44847b379578588920cA78FbF26c0B4956C";
  
  // Helper function to create a smart account client from a Privy wallet ID
  export async function createSmartAccountClientFromPrivyWalletId(walletId: string) {
